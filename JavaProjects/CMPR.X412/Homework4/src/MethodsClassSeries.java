...
public class MethodsClassSeries {
	 ...
	 * a certain phrase will be printed based on the order of the increment
	 * operators
	 * 
	...
	* @param no parameter
	* 
	* The box that was made from dashes and vertical bars is 
	* modified to use while loops and nested while loops instead of 
	* using just the println method
	* 
	* @exception no exception thrown
	* @return no return value
	**/
	...
	* @param no parameter
	* 
	* The box that was made from dashes and vertical bars with the while loop 
	* is modified to use do while loops
	* 
	* @exception no exception thrown
	* @return no return value
	**/
		...
		* @param no parameter
		* 
		* The box that was made from dashes and vertical bars with the do while loop 
		* is modified to use for loops now
		* 
		* @exception no exception thrown
		* @return no return value
		**/
		...
		* @param no parameter
		* 
		* The box that was made from dashes and vertical bars with the for loop 
		* is modified to now take user input for height, width and characters
		* 
		* @exception no exception thrown
		* @return no return value
		**/
		...
		**/
		 ...
		 * 
		 * For Homework #4.1 all important
		 * codes for this program is written in countLoop method. 
		 *
		 * For Homework #4.2 all important
		 * codes for this program is written in the
		 * printBox method and printWhileLoopBox method. 
		 * 
		 * For Homework #4.3 all important 
		 * codes for this program is written in the 
		 * printDoWhileLoopBox method
		 * 
		 * For Homework #4.4 all important
		 * codes for this program is written in the
		 * printForLoopBox method.
		 * 
		 * For Homework #4.5 all important
		 * codes for this program is written in the
		 * printForLoopBoxInput method.
		 * 
		 * For Homework #4.6 all important
		 * codes for this program is written in the
		 * printUserInputBox method.
		 * 
		 * 
		 */
