...
public class DataTypeSeries {
	...
	public static void onePrintArea() {
		...
		// use only one print statement instead of one print and one println statements
		// to show the same output (“The area is: xxxx.xx”).
		int radius = 2;
		double area;
	...
	public static void userInputPi() {
		// ...instead of hard-coding the value of PI in the program, get the value of PI
	...
	public static void userInputFormatSpecifiers() {
		Scanner readInput = new Scanner(System.in);
		// Declare four variables (decide on data type):First Name, Last Name, City, and
		// Zip
		String firstName;
		String lastName;
		String city;
		...
		// Ask user for the values for these variables and display them instead of using
		// the hardcoded name like Bill Clinton Harlem
